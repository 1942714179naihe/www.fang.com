...
@section('cnt')
    ...
    <article class="page-container">
        ...
        <form action="{{ route('admin.user.ownedit',['id'=>6]) }}" method="post" class="form form-horizontal" id="form-member-add">
            @csrf
            {{--{{ method_field('PUT') }}--}}
            @method('PUT')
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    ...
                    <input type="text" value="{{ $data->username }}" disabled class="input-text" name="username">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>实名：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" value="{{ $data->truename }}" class="input-text" name="truename">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" value="{{ $data->email }}" class="input-text" placeholder="@" name="email">
                </div>
            </div>
            <div class="row cl">
